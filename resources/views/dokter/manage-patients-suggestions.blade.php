...
<div class="min-h-screen bg-cover bg-center flex justify-center items-center" style="background-image: url('{{ asset('images/rl.jpg') }}');">
    <div class="max-w-4xl mt-6 w-full bg-white p-6 rounded-lg shadow-lg">
        <h1 class="text-3xl font-semibold text-gray-800 mb-4">Manage Suggestions for Patients</h1>
        
        <!-- Search Form -->
        <form method="GET" action="{{ route('dokter.managePatientsSuggestions') }}" class="mb-4">
            ...
            @foreach($pasiens as $pasien)
                <div class="bg-white p-4 rounded-lg shadow-md hover:bg-gray-100 transition">
                    ...
                    <div class="mt-4 flex space-x-4">
                        <a href="{{ route('dokter.managepatientspecificsuggestion', $pasien->id) }}" class="text-blue-500 hover:underline">View Suggestions</a>
