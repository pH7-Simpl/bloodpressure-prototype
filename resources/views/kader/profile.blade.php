...
<div class="container mx-auto mt-8">
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <form action="{{ route('kader.updateprofile') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $kader->nama) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nik" id="nik" value="{{ old('nik', $kader->nik) }}"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                        value="{{ old('tanggal_lahir', $kader->tanggal_lahir) }}"
                ...
                <div>
                    ...
                    <select name="jenis_kelamin" id="jenis_kelamin" class="w-full border-gray-300 rounded-md">
                        <option value="Laki-laki" {{ old('jenis_kelamin', $kader->jenis_kelamin) === 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                        <option value="Perempuan" {{ old('jenis_kelamin', $kader->jenis_kelamin) === 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="agama" id="agama" value="{{ old('agama', $kader->agama) }}"
                ...
                <div>
                    ...
                    <input type="text" name="golongan_darah" id="golongan_darah"
                        value="{{ old('golongan_darah', $kader->golongan_darah) }}"
                        class="w-full border-gray-300 rounded-md">
                </div>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $kader->email) }}"
                ...
                <div>
                    ...
                    <input type="text" name="provinsi" id="provinsi" value="{{ old('provinsi', $kader->provinsi) }}"
                        class="w-full border-gray-300 rounded-md">
                </div>
                {{-- Input Kabupaten Kota --}}
                <div>
                    <label for="kab_kota" class="block font-semibold">Kabupaten/Kota</label>
                    <input type="text" name="kab_kota" id="kab_kota" value="{{ old('kab_kota', $kader->kab_kota) }}"
                        class="w-full border-gray-300 rounded-md">
                </div>
                {{-- Input Kecamatan --}}
                <div>
                    <label for="kecamatan" class="block font-semibold">Kecamatan</label>
                    <input type="text" name="kecamatan" id="kecamatan" value="{{ old('kecamatan', $kader->kecamatan) }}"
                        class="w-full border-gray-300 rounded-md">
                </div>
        ...
        <div class="mt-6 border-t pt-6">
            ...
            <form action="{{ route('kader.delete') }}" method="POST">
                @csrf
                @method('DELETE')
